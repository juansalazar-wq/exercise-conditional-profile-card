...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name == null ? "Name" : variables.name} ${variables.lastName == null ? " Last Name" : variables.lastName
    }</h1>
          <h2>${variables.role == null ? "Role" : variables.role}</h2>
          <h3>${variables.city == null ? "City " : variables.city} ${variables.country == null ? "Country" : variables.country
    }</h3>
          <ul class="social ${variables.socialMediaPosition}">
